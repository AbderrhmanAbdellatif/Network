...
public class Server {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        try (ServerSocket serversocket = new ServerSocket(1234) //burda gelen port yani  bu port serverin port  clinet baglainma icin kullaniyor
        ) {
            //   Socket socket=null;
            // while (!serversocket.isClosed()) {
            socket = serversocket.accept(); // server acma  kanali
